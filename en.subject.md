...
- [V - Mandatory part - cub3D](#v---mandatory-part---cub3d)
...
| **External Functions** | `open`, `close`, `read`, `write`, `printf`, `malloc`, `free`, `perror`, `strerror`, `exit`, `gettimeofday`. All functions of the math library (`-lm` man man 3 math). All functions of the MinilibX library. |
...
### Example `.cub` scene (mandatory part)
...
- **Figure VIII.1:** Wolfenstein3D original design replica, using RayCasting.
